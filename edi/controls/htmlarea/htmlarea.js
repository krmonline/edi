...
//
// $Id: htmlarea.js,v 1.26 2005/10/28 14:20:59 mschering Exp $
...
HTMLArea.prototype.generate = function () {
	...
	iframe.src=_editor_url+'dummy.html';
...
HTMLArea.prototype.printContent = function() {
	if(HTMLArea.is_ie)
	{
			...
			if (HTMLArea.is_gecko) {
				if (typeof HTMLArea.I18N.msg["Moz-Clipboard"] == "undefined") {
					HTMLArea.I18N.msg["Moz-Clipboard"] =
						...
						"You can however already use SHIFT+INSERT";
				}
