<?php
require_once( dirname(__FILE__).'/../../../../classes/base/controls/html_element.class.inc' );
require_once( dirname(__FILE__).'/../../../../classes/base/controls/input.class.inc' );
require_once( dirname(__FILE__).'/../../../../classes/base/controls/button.class.inc' );
